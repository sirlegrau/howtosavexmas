...
var spr_jav_reg = preload("res://PLACEHOLDERS/Textures/Items/Weapons/javelin_3_new.png")
var spr_jav_atk = preload("res://PLACEHOLDERS/Textures/Items/Weapons/javelin_3_new_attack.png")
